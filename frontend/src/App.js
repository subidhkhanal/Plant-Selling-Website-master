...
const Routing = () => {
  return (
    <Routes>
      ...
      <Route
        exact
        path="/account/verificationEmail"
        element={<UserVerificationEmailSent />}
      />
      <Route
        exact
        path="/account/passwordResetEmail"
        element={<PasswordResetEmailSentPage />}
      />
      <Route
        exact
        path="/account/verificationConfirmation/:token"
        element={<UserVerificationConfirmAccount />}
      />
      <Route
        exact
        path="/account/ResetYourPassword/:token"
        element={<ResetYourPasswordPage />}
      />
      <Route exact path="/nursery" element={<NurseryProfilePage />} />
      <Route
        exact
        path="/nursery/store/view/:id"
        element={<NurseryPublicStorePage />}
      />{" "}
      ...
      <Route
        exact
        path="/nursery/plant/update/:id"
        element={<EditPlantsPage />}
      />{" "}
      {/* //TODO: NEED TO IMPLEMENTS THIS */}
