        ...
        <div className="col-12 col-md-6 col-lg-6 p-1 p-xl-5 d-flex justify-content-center align-items-center">
          <div className="header-intro-text">
            ...
            <p className="highlight-desc">
              Welcome to Crunican Orchards: Where Green Dreams Come True!
            </p>
            <p>
              Explore our lush collection of plants to elevate your living
              space. From vibrant succulents to elegant ferns, find the perfect
              green companions to breathe life into your home.
            </p>
            <p className="highlight-desc">Let's grow together!</p>
            <Link to="/products" className="btn btn-success d-flex">
              Go To Products{" "}
